...
class ResponsesModel extends Model // Defines a new class UserModel that extends CodeIgniter's Model class.
{
    protected $table = 'responses'; // Specifies the database table that this model should interact with.
    protected $primaryKey = 'reponse_id'; // Defines the primary key field of the table for CRUD operations.
    ...
    protected $allowedFields = ['question_id', 'response']; 
