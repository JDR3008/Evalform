...
class OptionsModel extends Model // Defines a new class UserModel that extends CodeIgniter's Model class.
{
    protected $table = 'options'; // Specifies the database table that this model should interact with.
    protected $primaryKey = 'option_id'; // Defines the primary key field of the table for CRUD operations.
    ...
    protected $allowedFields = ['question_id', 'option_text', 'created_at', 'updated_at']; 
